...
import { registerSalesPerson } from "../../store/Action/Admin";
import Loading from "../Loading";

const AdminSalesPerson = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(registerSalesPerson(formData));
  };
  ...
  return loading ? (
    ...
    >
      ...
      >
        Create SalesPerson <i className="ri-arrow-right-wide-line"></i>
      </button>
    </form>
...
export default AdminSalesPerson;
