...
const AdminManager = () => {
  ...
  const { managers, totalPages, message, error, loading } = useSelector(
    (state) => state.Admin
  ...
  useEffect(() => {
    dispatch(getAllManagers(currentPage, itemsPerPage));
  ...
  return (
    <div className="w-full h-screen overflow-hidden">
      ...
      <div className="flex w-full h-[89vh] overflow-hidden translate-y-20">
        <AdminSidebar title={"Managers"} isOpen={isOpen}></AdminSidebar>
        ...
        {loading ? (
          ...
          <div className="w-full p-10  h-full overflow-y-auto ">
            <div className="w-full flex items-center justify-between ">
              <div className="">
                <h1 className="text-3xl max-md:text-xl py-10">Managers</h1>
              </div>
              <button
                type="primary"
