    ...
    <div className="flex flex-col min-h-screen">
     <NavBar></NavBar>
      ...
      <div className="w-full flex justify-center items-center mt-10  py-8">
        <div className="bg-white w-full px-[9vw] rounded-lg p-6 flex flex-col md:flex-row gap-[5rem] items-center">
          ...
          <div className="w-full md:w-[42vw] ">
            ...
            <p className="text-gray-500 mb-6">
              ...
              <a
                href="mailto:xyz@mycozeein"
                className="text-[#5c59ff] underline"
              >
                mycozee1@gmail.com
              </a>
            </p>
